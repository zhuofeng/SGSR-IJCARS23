...
class StyleGANv2Generator(nn.Module):
    ...
    def __init__(self,
                 ...
                 bgr2rgb=False):
        '''
        pretrained: {'ckpt_path': 'http://download.openmmlab.com/mmgen/stylegan2/official_weights/stylegan2-cat-config-f-official_20210327_172444-15bc485b.pth', 'prefix': 'generator_ema'}
        bgr2rgb: default false
        '''
    ...
    def forward(self,
        ...
        # otherwise, we will adopt default noise sampler.
            ...
            styles = [s.to(device) for s in styles]
        # this maps noises a latent vector z into style
        if not input_is_latent:
            print('now is the style mapping') # in fact, no style mpping in glean
            noise_batch = styles
...
class StyleGAN2Discriminator(nn.Module):
    ...
    def __init__(self,
        ...
        '''
        pretrained: {'ckpt_path': 'http://download.openmmlab.com/mmgen/stylegan2/official_weights/stylegan2-cat-config-f-official_20210327_172444-15bc485b.pth', 'prefix': 'discriminator'}
        bgr2rgb: False
        ...
        # convs = [ConvDownLayer(1, channels[in_size], 1)]
